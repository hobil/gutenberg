...
PICKLEFILE = '../res/md.pickle.gz'  # The Python dict produced by this module
RDFFILES = '../res/rdf-files.tar.bz2'  # The catalog downloaded from Gutenberg
#RDFFILES = '../res/catalog.rdf'  # The catalog downloaded from Gutenberg
...
def readmetadata():
    ...
    if os.path.exists(PICKLEFILE):
        ...
        pickle.dump(metadata, gzip.open(PICKLEFILE, 'wb'), protocol=2)
...
def fixsubtitles(title):
    ...
    tmp = LINEBREAKER.sub(': ', title, 1)
    return LINEBREAKER.sub('; ', tmp)
